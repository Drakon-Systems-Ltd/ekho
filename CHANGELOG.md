...
### Security
This release closes the findings of the 9 Aug 2026 adversarial review (issues #5–#11). None require configuration changes to keep working; two add opt-in hardening knobs.
